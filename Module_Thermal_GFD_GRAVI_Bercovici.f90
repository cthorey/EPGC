MODULE MODULE_THERMAL_GFD_GRAVI_BERCOVICI
...
!!!!!!! schema difference fini
  ...
  SUBROUTINE THERMAL_GFD_SOLVER_BERCOVICI(Xi,H,P,T,Ts,BL,Dt,Dr,theta,dist,ray,M,sigma,nu,Pe,psi,delta0,el,grav,N1,F_err,z,tmps)
  ...
  END SUBROUTINE THERMAL_GFD_SOLVER_BERCOVICI
...
END MODULE MODULE_THERMAL_GFD_GRAVI_BERCOVICI
