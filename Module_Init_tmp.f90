...
!!!!!!!!  DECLARATION DES VARIABLES 
    ...
    sample = (Dt)/(Dt)
    Init = 0
    Input_Data_Name = 'Backup_000000.dat'
    Root = '//gpfs/users/thorey/'
    Input_Racine = Root//'ELAS/Run/E1D0_G0D0_N1D-3_P1D-3_D1D-2_C-3D-1_R1D0_S2D-2_Dr1D-2_Ep1D-4_Dt1D-6/'
    Output_Racine = Root//'ELAS/Run/E1D0_G0D0_N1D-3_P1D-3_D1D-2_C-3D-1_R1D0_S2D-2_Dr1D-2_Ep1D-4_Dt1D-6/'
