MODULE MODULE_THICKNESS_NEWTON_GRAV_BERCOVICI
...
!!!!!!!!  SUBROUTINE THICKNESS_NEWTON_SOLVER
  ...
  SUBROUTINE  THICKNESS_NEWTON_GRAV_BERCOVICI(H,P,T,BL,Ts,Dt,Dr,M,dist,ray,el,grav,sigma,nu,&
  ...
  END SUBROUTINE THICKNESS_NEWTON_GRAV_BERCOVICI
...
END MODULE MODULE_THICKNESS_NEWTON_GRAV_BERCOVICI
