MODULE MODULE_THICKNESS_NEWTON
...
!!!!!!!!  SUBROUTINE THICKNESS_NEWTON_SOLVER
  ...
  SUBROUTINE  THICKNESS_NEWTON_SOLVER(H,P,T,BL,Ts,Dt,Dr,M,dist,ray,el,grav,sigma,nu,delta0,z,F_err,theta)
  ...
  END SUBROUTINE THICKNESS_NEWTON_SOLVER
...
END MODULE MODULE_THICKNESS_NEWTON
