MODULE MODULE_THICKNESS_SKIN_NEWTON_BERCOVICI
...
!!!!!!!!  SUBROUTINE THICKNESS_NEWTON_SOLVER
  ...
  SUBROUTINE  THICKNESS_SKIN_NEWTON_BERCOVICI(H,P,T,BL,Ts,Dt,Dr,M,dist,ray,el,grav,sigma,nu,delta0,gam,z,F_err,theta)
  ...
  END SUBROUTINE THICKNESS_SKIN_NEWTON_BERCOVICI
...
END MODULE MODULE_THICKNESS_SKIN_NEWTON_BERCOVICI
